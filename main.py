...
if menu_choice == "Create College":
    ...
    if st.button("CREATE"):
        clg_obj=college(cname)   #creating acollege class object
        st.session_state.colleges.append(clg_obj)    #storing a college class object in college
    ...
    if not st.session_state.colleges:
        ...
        if st.button("Add Student"):
            ...
            stu_obj = student(roll,sname,branch)  #createdstudent object
    ...
    if not st.session_state.colleges:
        ...
        if st.button("Add Teacher"):
            if not (subject and tname and clgname and branch):
                ...
                clg_ob = find_college(clgname)  # find the college object based upon college name
                teacher_obj = teacher(subject,tname,branch)  #createdteacher object
